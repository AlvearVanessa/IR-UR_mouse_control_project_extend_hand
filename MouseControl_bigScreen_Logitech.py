""""
AI Virtual Mouse with Orbbec Femto Mega RGB + pantalla grande 3840x2160
Thur 19/09/24 08:37 CET
@uthor: maalvear
...
import cv2
import numpy as np
import HandTrackingModule_blackBackground_Logitech as htm
import time
import autopy
import mouse
...
print("w_screen, h_screen=", w_screen, h_screen)
print("w_screen//5, h_screen//4=", w_screen//5, h_screen//4)
...
while True:
    ...
    if success:
        ...
        if hands:
            ...
            if len(lm_list) != 0:
                ...
                if fingers1[1] == 1 and fingers1[2] == 0:
                    ...
                    # (0, h_screen + 200)
                    y3 = np.interp(y1, (frame_reduction, h_cam-frame_reduction), (0, h_screen+200))
        ...
        cv2.moveWindow("Big Screen", w_screen//3, h_screen//4)  # Move it to (x,y) (0, 110)
